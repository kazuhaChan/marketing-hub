    ...
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', color: 'var(--text-main)' }}>
      ...
      <div style={{ background: 'rgba(30, 41, 59, 0.7)', padding: '40px', borderRadius: 'var(--radius)', border: '1px solid var(--border)' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: '30px' }}>
          Ngày cập nhật gần nhất: 1 tháng 6, 2026
        </p>
        ...
        <section style={{ marginBottom: '24px' }}>
          ...
          <p style={{ marginBottom: '16px', lineHeight: '1.6' }}>
            Chính sách bảo mật này giải thích cách chúng tôi tiếp nhận, sử dụng và (trong trường hợp nào đó) tiết lộ thông tin cá nhân của Quý khách.
          </p>
          <p style={{ marginBottom: '16px', lineHeight: '1.6' }}>
            Bảo vệ dữ liệu cá nhân và gây dựng được niềm tin cho quý khách là vấn đề rất quan trọng với chúng tôi. Vì vậy, chúng tôi sẽ dùng tên và các thông tin khác liên quan đến quý khách tuân thủ theo nội dung của Chính sách bảo mật. Chúng tôi chỉ thu thập những thông tin cần thiết liên quan đến giao dịch mua bán và sử dụng hệ thống.
          </p>
          <p style={{ marginBottom: '16px', lineHeight: '1.6' }}>
